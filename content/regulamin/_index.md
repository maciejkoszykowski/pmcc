...
1. Konferencja PM CONNECT CONF – zwana w dalszej części Regulaminu „konferencją” lub „wydarzeniem” odbędzie się w dniu 24.10.2026 roku na Wydziale Nauk Ekonomicznych i Zarządzania UMK w Toruniu, zlokalizowanym przy ul. Gagarina 13a, 87-100 Toruń.  
...
3. Oficjalny serwis internetowy Konferencji PM CONNECT CONF znajduje się pod adresem: [https://pmcc.pmi.org.pl/](https://pmcc.pmi.org.pl/), a oficjalnym kanałem komunikacji pomiędzy Uczestnikiem a Organizatorem jest adres e-mail: kujawsko-pomorskie@pmi.org.pl.  
4. Organizator zastrzega sobie prawo do zmiany prelegentów i programu Konferencji z przyczyn niezależnych od Organizatora.  
5. Strona internetowa konferencji znajduje się pod adresem [https://pmcc.pmi.org.pl/](https://pmcc.pmi.org.pl/) – w dalszej części regulaminu nazywaną „stroną internetową wydarzenia”.  
6. Na potrzeby niniejszego Regulaminu poniższe pojęcia mają następujące znaczenie:  
* **Konferencja / Wydarzenie** – wydarzenie edukacyjno-networkingowe pod nazwą **PM CONNECT CONF**, organizowane przez Project Management Institute Poland Chapter (PMI Poland Chapter) oraz Wydział Nauk Ekonomicznych i Zarządzania Uniwersytetu Mikołaja Kopernika w Toruniu, odbywające się w dniu 24 października 2026 roku w Toruniu.  
...
1. Podstawą uczestnictwa w konferencji jest zakup biletu dostępnego na stronie internetowej [https://pmcc.pmi.org.pl/](https://pmcc.pmi.org.pl/) poprzez wypełnienie formularza rejestracji oraz uiszczenie opłaty za uczestnictwo do dnia wymienionego w formularzu zgłoszeniowym. Liczy się data zaksięgowania wpłaty na konto Organizatora. Uczestnik ponosi koszty połączenia Internetowego związane z rejestracją na konferencję.  
2. Uczestnik zobowiązany jest do uiszczenia opłaty w terminie 3 dni od przesłania formularza (najpóźniej na dzień przed konferencją, tj. 23.10.2026), a w przypadku niedokonania opłaty w tym terminie zgłoszenie będzie anulowane.  
...
9. Zgłoszenia uczestnictwa przyjmowane będą do dnia 24.10.2026 lub wyczerpania miejsc.  
...
2. Cennik opłat konferencyjnych dostępny jest na stronie internetowej wydarzenia:  
   * Dla uczestników zarejestrowanych do 04.06.2026 włącznie (Blind Sale) cena wynosi 199 PLN brutto za osobę. Wyłącznie indywidualni kupujący mają możliwość zakupu biletu w ramach Blind Sale. Nie ma możliwości zakupu biletu grupowego w tej opcji; płatność możliwa jest wyłącznie przez wbudowany system płatności, bez opcji przelewu na konto. 
   * Dla uczestników zarejestrowanych od 05.06.2026 do 31.07.2026 włącznie (Summer Sale) cena wynosi 249 PLN brutto za osobę.  
   * Dla uczestników zarejestrowanych od 01.08.2026 do 30.09.2026 włącznie (Early Birds) cena wynosi 349 PLN brutto za osobę.  
   * Dla uczestników zarejestrowanych od 01.10.2026 do 21.10.2026 włącznie (Regular tickets) cena wynosi 449 PLN brutto za osobę.  
   * Dla uczestników zarejestrowanych od 21.10.2026 (Late Birds) cena wynosi 599 PLN brutto za osobę.  
...
4. Szczegółowe zasady dotyczące zbierania i przetwarzana danych Uczestników Konferencji, opisane są w Polityce Prywatności: [http://pmi.org.pl/polityka-prywatnosci](http://pmi.org.pl/polityka-prywatnosci).
...
utrwalonych na rzecz Konferencji PM CONNECT CONF 2026 na potrzeby komunikacji promującej działania Project Management Institute Poland Chapter i Wydziału Nauk Ekonomicznych i Zarządzania Uniwersytetu Mikołaja Kopernika w Toruniu oraz promocji wydarzenia, tj. Konferencji PM CONNECT CONF 2026 w PMI Poland Chapter. Zgoda obejmuje również dokonywanie obróbki, opracowań, powielanie i publikowanie wykonanych ujęć zdjęciowych, na następujących polach eksploatacji:
